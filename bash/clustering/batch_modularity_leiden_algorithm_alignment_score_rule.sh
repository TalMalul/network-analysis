...
TEMPLATE_BATCH_FILE="/groups/vaksler_group/Tal/python/NetworkAnalysis/Scripts/template_batches/clustering/batch_modularity_leiden_algorithm_alignment_score_rule_batch_template.sbatch"
