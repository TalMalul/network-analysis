...
TEMPLATE_BATCH_FILE="/groups/vaksler_group/Tal/python/NetworkAnalysis/Scripts/template_batches/cluster_coefficients_alignment_score_decent_batch_template.sbatch"
