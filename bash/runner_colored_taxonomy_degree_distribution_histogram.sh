...
TEMPLATE_BATCH_FILE="/groups/vaksler_group/Tal/python/NetworkAnalysis/Scripts/template_batches/colored_taxonomy_degree_distribution_histogram_batch_template.sbatch"
