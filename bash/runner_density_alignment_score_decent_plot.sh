...
TEMPLATE_BATCH_FILE="/groups/vaksler_group/Tal/python/NetworkAnalysis/Scripts/template_batches/density_alignment_score_decent_plot_batch_template.sbatch"
