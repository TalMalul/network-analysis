...
TEMPLATE_BATCH_FILE="/groups/vaksler_group/Tal/python/NetworkAnalysis/Scripts/template_batches/filter_network_by_protein_sequence_length_batch_template.sbatch"
