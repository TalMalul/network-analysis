...
TEMPLATE_BATCH_FILE="/groups/vaksler_group/Tal/python/NetworkAnalysis/Scripts/template_batches/neighborhood_local_clustering_coefficient_batch_template.sbatch"
