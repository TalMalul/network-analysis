...
TEMPLATE_BATCH_FILE="/groups/vaksler_group/Tal/python/NetworkAnalysis/Scripts/template_batches/possible_edges_count_between_taxonomy_batch_template.sbatch"
