...
TEMPLATE_BATCH_FILE="/groups/vaksler_group/Tal/python/NetworkAnalysis/Scripts/template_batches/taxonomy_modularity_alignment_score_decent_batch_template.sbatch"
